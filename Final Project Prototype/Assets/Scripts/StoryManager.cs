...
public class StoryManager:MonoBehaviour
{
    ...
    IEnumerator Ending()
    {
        ...
        displayMessage("i remember my sister now. i remember how she cared and mentored me", 3f);
        yield return new WaitForSeconds(3.0f);
    ...
    IEnumerator ExecuteWithDelay()
    {
        ...
        displayMessage("my name is Olivia Campbell. i am a psychology student from Ohio",  3f);
        ...
        yield return new WaitForSeconds(3f);
        displayMessage("she asked me to go back to our old house to look for something important", 3f);
        yield return new WaitForSeconds(3f);
        displayMessage("she refused to tell me why, but i had to agree", 3f);
        yield return new WaitForSeconds(3f);
